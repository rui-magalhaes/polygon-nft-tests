...
module.exports = async({
    ...
    log(`You've minted an NFT from SVGNFT`)
    log(`You can view the tokenURI here ${await svgNFT.tokenURI((await svgNFT.tokenCounter()).toNumber()-1)}`)
}